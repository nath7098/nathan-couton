export default {
  ...
  projects: [
    {
      ...
      role: 'Dev fullstack en mission',
      title: 'Intégration des flux',
      description: 'Développement sur toute la chaîne de valeur de l\'intégration des flux, de la réception à la restitution.',
    },
    {
      year: '2021 - 2025',
    ...
    },
    {
      year: '2020',
      context: 'Polytech Tours',
      role: 'Projet de fin d\'études, R&D',
  ...
  other: [
    ...
    },
    {
      year: '2019',
      context: 'Polytech Tours',
      role: 'Projet de groupe, 5 élèves',
    ...
    {
      year: '2020',
      context: 'Client artisan',
      role: 'Site vitrine, seul',
      title: 'AJL Peinture',
