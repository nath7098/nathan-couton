export default {
  ...
  projects: [
    {
      meta: 'Mutuelle de Poitiers · dev fullstack en mission',
      title: 'Prévoyance',
    ...
    {
      meta: 'Perso · conception et développement',
      title: 'Portfolio',
      description: 'Migration de mon ancien portfolio static (html, css) vers Vue/ExpressJs',
    },
    {
      meta: 'Polytech Tours · projet libre de 5ᵉ année',
    ...
    {
      meta: 'Polytech Tours · projet de fin d\'études, R&D',
  ...
  other: [
    {
      meta: 'Polytech Tours × Sopra Banking · groupe de 6',
    ...
    {
      meta: 'Polytech Tours · groupe de 5, reprise d\'une app',
    ...
    {
      meta: 'Perso · apprentissage du web',
    ...
    {
      meta: 'Client artisan · site vitrine, seul',
      title: 'AJL Peinture',
